    ...
    <div>
        <div class="card-body p-4 p-md-5">
            ...
            <div class="form-outline mb-4">
                ...
                <div class="row">
                    <div class="col-md-6 mb-4">
                        <input type="text" name="numPermis" id="NumPermis" placeholder="Numéro de permis" class="form-control">
                    </div>
                    <div class="col-md-6 mb-4">
                ...
                <div class="d-flex justify-content-center align-items-center">
                <input type="submit" name="connexion" id="Connexion" value="Connexion" class="btn btn-primary col-6">
                </div>
            </form>
        </div>
    </div>
