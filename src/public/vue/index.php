        ...
        <form action="">
            <div class="col-sm-12 selectVehicle">
                ...
                <div class="btn-group mb-3" role="group" aria-label="Basic example">
                    <button type="button" class="btn btn-primary"><i class="fa-solid fa-car-side"></i> Voiture</button>
                    <button type="button" class="btn btn-primary"><i class="fa-solid fa-truck"></i> Utilitaires</button>
                    <button type="button" class="btn btn-primary"><i class="fa-solid fa-car-side"></i> Prestige</button>
                </div>
            </div>
            <div class="row">
                <div class="col">
                ...
                <div class="col">
                    ...
                    <input type="password" class="form-control" name="lieuRetour">
                </div>
            ...
            <div>
                <input class="btn btn-primary mt-3 float-end" type="submit" value="Rechercher">
            </div>
        </form>
    </div>
